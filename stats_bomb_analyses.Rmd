...
tab_pass=function(ffs){
  ...
  # création d'un tableau qui affiche en ordre décroissant le nombre de joueurs éliminés par chaque joueur lors d'un match 
   
  # newdata <- tab1[order(-num_elim_players),] # tri en fonction de la colonne num_elim_player
  # newdata
#   return(tab1)
}
...
line_breaking_all_matchs=function(Matches,begin=1,end=nrow(Matches)){
  ...
  for (i in begin:end){
    ...
    if (i == 1){
      ...
      join_dataframe(recap,num_eliminated_player_for_this_match)
    }
...
Tab_recap = line_breaking_all_matchs(Matches,1,20)
<<<<<<< HEAD
