...
```{r}
display_passes("5ab8ca4a-3626-4e46-8582-914dbe76e173")
```
```{r}
France_1=filter(ffs,id=="5ab8ca4a-3626-4e46-8582-914dbe76e173")
```
...
line_breaking_all_matchs=function(Matches,begin=1,end=nrow(Matches)){
  ...
  #pass.technique.name
    ...
    # -------------------------------------------
    print("on est avant la boucle")
    if (i == 1){
      print("on rentre dans la première boucle")
      recap = tab_pass(ffs)
      
    }else{
      num_eliminated_player_for_this_match = tab_pass(ffs)
...
line_breaking_all_matchs(Matches,1,3)
